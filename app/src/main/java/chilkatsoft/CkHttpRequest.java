...
public class CkHttpRequest {
  ...
  public boolean AddMwsSignature(String domain, String mwsSecretKey) {
    return chilkatJNI.CkHttpRequest_AddMwsSignature(swigCPtr, this, domain, mwsSecretKey);
  }
  ...
  public boolean GenerateRequestFile(String path) {
    return chilkatJNI.CkHttpRequest_GenerateRequestFile(swigCPtr, this, path);
  }
  ...
  public boolean LoadBodyFromBd(CkBinData requestBody) {
    return chilkatJNI.CkHttpRequest_LoadBodyFromBd(swigCPtr, this, CkBinData.getCPtr(requestBody), requestBody);
  }
  ...
  public boolean LoadBodyFromSb(CkStringBuilder requestBody, String charset) {
    return chilkatJNI.CkHttpRequest_LoadBodyFromSb(swigCPtr, this, CkStringBuilder.getCPtr(requestBody), requestBody, charset);
  }
