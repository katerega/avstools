...
public class CkPrivateKey {
  ...
  public boolean LoadAnyFormat(CkBinData privKeyData, String password) {
    return chilkatJNI.CkPrivateKey_LoadAnyFormat(swigCPtr, this, CkBinData.getCPtr(privKeyData), privKeyData, password);
  }
